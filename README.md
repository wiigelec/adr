...
- `FS-003` — ADR Application Realization and Initialization: realization/semantic separation, determinate fresh-session initialization, initialization without implicit Dataset mutation, and provider/packaging independence.
